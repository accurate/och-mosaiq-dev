<?php
/* Template Name: Landing - Apartments (New Layout)
...
?>
    ...
    while ( have_posts() ):
        ...
        if( have_rows('pricing_table_floor') ):
            while( have_rows('pricing_table_floor') ): the_row();
                $floor_button_studio_text = get_sub_field('floor_button_studio_text');
                $floor_button_studio_url = get_sub_field('floor_button_studio_url');
                $floor_button_1br_text = get_sub_field('floor_button_1bed_text');
                $floor_button_1br_url = get_sub_field('floor_button_1bed_url');
                $floor_button_2br_text = get_sub_field('floor_button_2bed_text');
                $floor_button_2br_url = get_sub_field('floor_button_2bed_url');
                $floor_button_3br_text = get_sub_field('floor_button_3bed_text');
                $floor_button_3br_url = get_sub_field('floor_button_3bed_url');
            endwhile;
        endif;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="properties-table">
                                    ...
                                    <tr class="border-bottom-darkgrey bgcolor-grey-light">
                                        <td><strong><?php _e('Virtual Tour ','mosaiq') ?></strong></td>
                                        <td class="border-left-lightgrey">
                                        </td>
                                        <td class="border-left-lightgrey">
                                        </td>
                                        <td class="border-left-lightgrey">
                                            <a class="mos-btn register-btn" href="<?php echo $floor_button_2br_url; ?>" data-lity=""><?php echo $floor_button_2br_text; ?></a>
                                        </td>
                                        <td class="border-left-lightgrey">
                                        </td>
                                    </tr>
                ...
                <div id="landingblock-virtualtour" class="section-wrapper">
                    <div class="container">
                        ...
                        <div class="row" id="virtualtour-container">
                            ...
                            <div class="col-lg-12">
                                <iframe id="virtual-tour-video" width="100%" height="410" src="<?php echo get_sub_field('video_link'); ?>" frameborder="0" allowfullscreen allow="xr-spatial-tracking"></iframe>
                            </div>
                        </div>
        ...
        if ( is_user_logged_in() ) :
            ...
            if( have_rows('videos_group') ):
                ...
                ?>
                    ...
                    <div id="videolist-wrapper" class="section-wrapper" style="border-bottom-width:20px !important;">
                        <div class="container">
